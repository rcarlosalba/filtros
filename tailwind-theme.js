const style = {
  ...
  'family:button': {
    ...
    wrapper: 'mb-0 flex justify-center',
  ...
  select: {
    inner:
      'flex relative max-w-full items-center rounded mb-1 ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-blue-500',
    input:
